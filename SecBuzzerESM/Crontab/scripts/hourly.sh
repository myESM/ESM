...
ETA_Attack_Index=cic_`date "+%Y%m%d"`
curl -i "http://eta_attack:5000/eta_attack/api/v1.0?index=$ETA_Attack_Index&start_time="$hourtime":00:00.000000%2b0800&end_time="$hourtime":59:59.999999%2b0800"
